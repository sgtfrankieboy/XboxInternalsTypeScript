...
module XboxInternals.AvatarAsset {
    ...
    export enum SkeletonVersion {
        Nxe = 1,
        Natal,
        NxeAndNatal
    }

    export enum AssetGender {
        Male = 1,
        Female,
        Both
    }

    export interface STRBHeader {
        magic: number;
